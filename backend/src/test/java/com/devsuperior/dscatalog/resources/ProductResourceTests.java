...
public class ProductResourceTests {
	...
	public void deleteShouldReturnNotFoundWhenIdDoesNotExist () throws Exception {
		ResultActions res = mockMvc.perform(delete("/products/{id}", nonExistingId).accept(MediaType.APPLICATION_JSON));
	...
	public void deleteShouldReturnNoContentWhenIdExists () throws Exception {
		ResultActions res = mockMvc.perform(delete("/products/{id}", existingId).accept(MediaType.APPLICATION_JSON));
	...
	public void insertShouldReturnCreatedAndProductDTO () throws Exception {
		...
		ResultActions res = mockMvc.perform(post("/products").accept(MediaType.APPLICATION_JSON)
	...
	ResultActions res = mockMvc.perform(get("/products/{id}", existingId).accept(MediaType.APPLICATION_JSON));
	...
	ResultActions res = mockMvc.perform(get("/products/{id}", nonExistingId).accept(MediaType.APPLICATION_JSON));
